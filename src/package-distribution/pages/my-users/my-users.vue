...
<template>
  <view class="Mall4j container">
    <view class="my-user">
      <view class="user-bg">
        <view class="text">{{ i18n.inTotal }}
          <view class="number">{{ totalInvite }}</view>
          {{ i18n.people }}
        </view>
      </view>
      <view v-if="records.length > 0" class="user-list">
        <view class="table">
          <view class="tr title">
              ...
              <view class="td flex-space flex-item">
                ...
                <view class="user-info">
                  ...
                  <view class="join-time text-nowrap">
                    {{ i18n.accumulatedOrders }}{{ item. orderNumber }}
                  </view>
                </view>
              </view>
