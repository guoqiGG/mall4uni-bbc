...
<template>
  ...
  <block v-if="node.node == 'element'">
    ...
    <!--a类型-->
    <view v-else-if="node.tag == 'a'" :class="node.classStr" :data-href="node.attr.href" :style="node.styleStr" style="display: inline; border-bottom: 1px solid #555555;" @click="wxParseATap(node.attr,$event)">
    ...
    <!--img类型-->
    <wx-parse-img v-else-if="node.tag == 'img'" :node="node" :style="node.styleStr" />
