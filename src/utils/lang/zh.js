...
export const index = {
  ...
  'pointsDeduction': '氢春豆抵扣',
  'enterPoints': '请输入氢春豆数量',
  'enterCorrectPoints': '请输入正确的氢春豆数量',
  'mostUserPoints': '该订单最多使用',
  'integral': '氢春豆',
  'notEnough': '氢春豆不足!',
  'multipleOf10': '请输入10的倍数',
  'notUsePoints': '不使用氢春豆抵扣',
  'prodTransfee': '商品运费',
  'freightPayable': '应付运费',
  ...
  'signedIn': '已签到',
  'dayItem': '第',
  'integralActivity': '氢春豆活动',
  'pointsMall': '氢春豆商城',
  'exchangePointsGoods': '氢春豆兑换好物',
  'largeTurntable': '大转盘',
  'PointsLuckyDraw': '氢春豆抽奖活动',
  'integralTask': '氢春豆任务',
  'shoppingMall': '商城购物',
  'shoppingMallGet': '商城购物可获得氢春豆',
  'itemYuan': '元/氢春豆',
  'goShopping': '去购物',
  ...
  // integralDetail.vue
  'integralStrategy': '氢春豆攻略',
  'rewardPointsGoods': '购买商品获赠氢春豆',
  'refundShopping': '退款扣除购物获赠氢春豆',
  'pointsLevelPromotion': '等级提升获赠氢春豆',
  'signGetPoints': '签到获赠氢春豆',
  'refundGoodsPoints': '商品退款退回抵现氢春豆',
  'purchaseGoodsPoints': '购买商品抵扣氢春豆',
  'noDetails': '暂无明细',
  'pointsExpired': '氢春豆过期',
  'rechargeGetPoints': '充值余额获赠氢春豆',
  'registerEarnPoints': '注册获赠氢春豆',
  ...
  'invoice': {
    ...
    'invoiceTips3': '开票金额为实际支付金额，不包括优惠券、氢春豆、红包等支付金额',
    ...
    'questions3': '发票开具金额：开票金额为您实际支付金额，不包括优惠券、氢春豆、红包等支付金额；',
